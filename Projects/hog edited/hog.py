...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            n = score0 - curr
            if n > running_high:
                print(n, "point(s)! That's a record gain for Player 0!")
            else:
                n = running_high
            curr = score0
        else:
            n = score1 - curr
            if n > running_high:
                print(n, "point(s)! That's a record gain for Player 1!")
            else:
                n = running_high
            curr = score1
        return announce_highest(who, curr, n)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    nmax, n = 0, 1
    while n <= 10:
        make = make_averaged(roll_dice, trials_count)(n, dice)
        if make > nmax:
            nmax = make
            num = n
        n += 1
