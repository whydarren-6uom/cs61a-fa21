...
def non_decrease_subseqs(s):
    ...
    def subseq_helper(s, prev):
        if not s:
            ...
            a = s[0]
            b = [sub for sub in subseq_helper(s[1:], s[0])]
            return insert_into_all(a, b) + subseq_helper(s[1:], 0)
...
class Account:
    ...
    def __repr__(self):
        return f"Accountholder: {self.holder}, Deposits: {self.num_dep}, Withdraws: {self.num_wit}"
